...
//        var deals = [Deal]()
//        
//        let coffeShops = APIManager.shared.getAllCoffeShops()
//        
...
//        if let coffeeShopId = notificationDictionary["coffeShopId"] as? String, let coffeShop = APIManager.shared.getCoffeShopBy(coffeeShopId) {
